    ...
    <div class="horizontal-main-wrapper">
        ...
        <!-- header area end -->
                        ...
                        <div class="row align-items-center">
                            <div class="col-sm-12">
                                 <div class="breadcrumbs-area clearfix">
                                    <h4 class="page-title pull-left">Daftar Feedback</h4>
              ...
              <!-- <table id="example" class="table table-striped table-bordered nowrap" style="width:100%"> -->
                              <h4 class="header-title">Table Feedback</h4>
                                <div class="data-tables">
							        ...
							        <?php 
										...
										$index = 1;
										$data = mysqli_query($conn,"select * from feed_back");
										...
										?>
							             <tr>
							                ...
							                <td><?php echo date("d-m-Y", ($result['updatedAt']/1000)) ?></td>
							            </tr>
							            <?php 
							        		}
							            ?>
