  ...
  <?php 
    ...
    include 'dbConfig/deleteUser.php';
     ?>
    <!doctype html>
<html lang="en">
<head>
    ...
    <div class="horizontal-main-wrapper">
                        ...
                        <div class="row align-items-center">
                            <div class="col-sm-12">
                                <div class="breadcrumbs-area clearfix">
                                    <h4 class="page-title pull-left">Daftar User</h4>
                                ...
                                <tbody> 
                                    ...
                                    ?>
                                     <tr>
                                        ...
                                        <td><?php  echo date("d-m-Y", ($result['createdAt']/1000)) ?></td>
                                        <td><a href='index.php?username=<?php echo $result['username'] ?>'>Delete</a></td>
                                    </tr>
                                    <?php } ?>
                                 </tbody>  
                            </table> 
        ...
        <footer>
            <div class="card_new mt-3 prm_color txt_footer mb-3">
                <p class="txt_footer">© Copyright 2021 Bawazir Bagas</a></p>
            </div>
        </footer>
        <!-- footer area end-->
    </div>
