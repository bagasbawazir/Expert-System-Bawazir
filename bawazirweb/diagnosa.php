						       ...
						       <h4 class="header-title">Table Diagnosa</h4>
                                <div class="data-tables">
						          ...
						          <?php 
                                    ...
                                    $index = 1;
                                    $data = mysqli_query($conn,"select diagnosa.username,diagnosa.location,hasil, diagnosa.persentase,diagnosa.createdAt, diagnosa.id from diagnosa join user on user.username = diagnosa.username ORDER BY diagnosa.createdAt DESC ");
                                    ...
                                    ?>
                                     <tr>
                                        ...
                                        <td><?php
                                         ...
                                         ?></td>
                                         <td>
                                            <a class="btn btn-default" style="border-radius: 50%;" href="detaildiagnosa.php?id=<?=$result['id']?>" role="button"><span class="fa fa-info-circle fa-2x"></span></a>                                            
                                         </td>
                                    </tr>
                                    <?php 
                                        }
