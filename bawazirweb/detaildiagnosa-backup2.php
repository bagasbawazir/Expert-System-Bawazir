						       ...
						       <h4 class="header-title">Table Detail Diagnosa</h4>
                                <div class="data-tables">
						          ...
						          <?php 
                                    ...
                                    $t_id = $_GET['id'];
                                    $index = 1;
                                    $sql = "select d.location, pt.*, py.* from diagnosa d 
                                    join penyakit py on d.hasil = py.penyakit 
                                    join pertanyaanpenyakit pp on pp.kodepenyakit = py.kode
                                    join pertanyaan pt on pt.id = pp.idpertanyaan where d.id = '$t_id'";
                                    $data = mysqli_query($conn, $sql);
                                    $totrow = mysqli_num_rows($data);
                                    // die;
